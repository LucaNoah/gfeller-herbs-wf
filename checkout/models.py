...
class Order(models.Model):
    ...
    def update_total(self):
        ...
        """
        self.order_total = self.orderlineitems.aggregate(Sum('lineitem_total'))['lineitem_total__sum'] or 0
    ...
    def save(self, *args, **kwargs):
        """
        Override original save method to set an order number if none has been set yet
        """
...
class OrderLineItem(models.Model):
    ...
    def save(self, *args, **kwargs):
        """
        Override original save method to set the lineitem total and update oder total
        """
